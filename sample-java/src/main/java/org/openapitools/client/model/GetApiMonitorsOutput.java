...
public class GetApiMonitorsOutput {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<ApiLog> items = new ArrayList<ApiLog>();
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "API 모니터링 정보 목록")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetApiMonitorsOutput getApiMonitorsOutput = (GetApiMonitorsOutput) o;
    return Objects.equals(this.items, getApiMonitorsOutput.items) &&
        Objects.equals(this.meta, getApiMonitorsOutput.meta) &&
        Objects.equals(this.links, getApiMonitorsOutput.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetApiMonitorsOutput {\n");
