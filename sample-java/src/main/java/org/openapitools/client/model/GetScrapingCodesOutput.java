...
public class GetScrapingCodesOutput {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<ScrapingCode> items = new ArrayList<ScrapingCode>();
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "스크랩핑 코드 목록")

  public List<ScrapingCode> getItems() {
    return items;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetScrapingCodesOutput getScrapingCodesOutput = (GetScrapingCodesOutput) o;
    return Objects.equals(this.items, getScrapingCodesOutput.items) &&
        Objects.equals(this.meta, getScrapingCodesOutput.meta) &&
        Objects.equals(this.links, getScrapingCodesOutput.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetScrapingCodesOutput {\n");
