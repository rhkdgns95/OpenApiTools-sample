...
public class SearchChargeJangbusOutput {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<ChargeJangbu> items = new ArrayList<ChargeJangbu>();
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "정산내역 목록")

  public List<ChargeJangbu> getItems() {
    return items;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    SearchChargeJangbusOutput searchChargeJangbusOutput = (SearchChargeJangbusOutput) o;
    return Objects.equals(this.items, searchChargeJangbusOutput.items) &&
        Objects.equals(this.meta, searchChargeJangbusOutput.meta) &&
        Objects.equals(this.links, searchChargeJangbusOutput.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class SearchChargeJangbusOutput {\n");
