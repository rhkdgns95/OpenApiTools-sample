...
public class GetErrorsResponse {
  ...
  private List<PcClientError> items = new ArrayList<PcClientError>();
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "PC클라이언트 에러목록")

  public List<PcClientError> getItems() {
    return items;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetErrorsResponse getErrorsResponse = (GetErrorsResponse) o;
    return Objects.equals(this.items, getErrorsResponse.items) &&
        Objects.equals(this.meta, getErrorsResponse.meta) &&
        Objects.equals(this.links, getErrorsResponse.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetErrorsResponse {\n");
