...
public class GetWorksOutput {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<Work> items = new ArrayList<Work>();
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "업무 목록")
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetWorksOutput getWorksOutput = (GetWorksOutput) o;
    return Objects.equals(this.items, getWorksOutput.items) &&
        Objects.equals(this.meta, getWorksOutput.meta) &&
        Objects.equals(this.links, getWorksOutput.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetWorksOutput {\n");
