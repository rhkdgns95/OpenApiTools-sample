...
public class GetJangbusOutput {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<Jangbu> items = new ArrayList<Jangbu>();
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "장부사 목록")

  public List<Jangbu> getItems() {
    return items;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetJangbusOutput getJangbusOutput = (GetJangbusOutput) o;
    return Objects.equals(this.items, getJangbusOutput.items) &&
        Objects.equals(this.meta, getJangbusOutput.meta) &&
        Objects.equals(this.links, getJangbusOutput.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetJangbusOutput {\n");
