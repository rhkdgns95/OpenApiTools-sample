...
public class GetAppVersionsOutput {
  public static final String SERIALIZED_NAME_ITEMS = "items";
  @SerializedName(SERIALIZED_NAME_ITEMS)
  private List<AppVersion> items = new ArrayList<AppVersion>();
   ...
   * @return items
  **/
  @ApiModelProperty(required = true, value = "증빙앱 버전 목록")

  public List<AppVersion> getItems() {
    return items;
  }
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    GetAppVersionsOutput getAppVersionsOutput = (GetAppVersionsOutput) o;
    return Objects.equals(this.items, getAppVersionsOutput.items) &&
        Objects.equals(this.meta, getAppVersionsOutput.meta) &&
        Objects.equals(this.links, getAppVersionsOutput.links);
  }
  ...
  public String toString() {
    ...
    sb.append("class GetAppVersionsOutput {\n");
