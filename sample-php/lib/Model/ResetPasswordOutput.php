...
/**
 * ResetPasswordOutput Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ResetPasswordOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ResetPasswordOutput';
     ...
     * Sets recovery
     *
     * @param Recovery $recovery 비밀번호 초기화 정보
     *
     * @return self
     */
