...
/**
 * RegisterCustomerInput Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RegisterCustomerInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RegisterCustomerInput';
     ...
     * Sets jangbu_id
     *
     * @param float|null $jangbu_id 장부사 순번
     *
     * @return self
     */
     ...
     * Sets service_id
     *
     * @param float $service_id 서비스 순번 (장부사 및 관리자 회원의 경우에는 생략)
     *
     * @return self
     */
