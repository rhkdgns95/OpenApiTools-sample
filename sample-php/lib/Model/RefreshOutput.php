...
/**
 * RefreshOutput Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RefreshOutput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RefreshOutput';
     ...
     * Sets access_token
     *
     * @param string $access_token 엑세스토큰
     *
     * @return self
     */
     ...
     * Sets refresh_token
     *
     * @param string $refresh_token 리프레시토큰
     *
     * @return self
     */
